# Task 03 — Forcar HTTPS em endpoints + cifrar auth_secret
...
Objetivo: Forcar HTTPS em endpoints + cifrar auth_secret.
...
4. `backend/routes/agents.js`
5. `backend/services/crypto/SecretVault.js`
