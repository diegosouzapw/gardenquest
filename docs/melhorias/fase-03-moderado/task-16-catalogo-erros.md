# Task 16 — Catalogo de erros + correlation-id E2E
...
Objetivo: Catalogo de erros + correlation-id E2E.

## Ordem de implementacao (arquivo a arquivo)
1. `backend/shared/errors.js`
2. `backend/middleware/request-context.js`
3. `backend/server.js`
4. `backend/api-server.js`
5. `backend/routes/logs.js`
