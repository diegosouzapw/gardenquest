# Task 18 — JSDoc nas classes publicas de servico
...
Objetivo: JSDoc nas classes publicas de servico.

## Ordem de implementacao (arquivo a arquivo)
1. `backend/services/agents/AgentDecisionService.js`
2. `backend/services/agents/AgentGovernanceService.js`
3. `backend/services/world/WorldEventStreamService.js`
4. `backend/services/world/WorldRuntimeWorker.js`
