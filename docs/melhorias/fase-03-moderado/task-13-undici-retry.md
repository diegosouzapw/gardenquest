# Task 13 — Substituir https nativo por undici com retry
...
Objetivo: Substituir https nativo por undici com retry.

## Ordem de implementacao (arquivo a arquivo)
1. `backend/services/openai-client.js`
2. `backend/agents/providers/HostedApiKeyProvider.js`
3. `backend/agents/providers/RemoteEndpointProvider.js`
