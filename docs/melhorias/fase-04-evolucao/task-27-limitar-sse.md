# Task 27 — Limitar SSE subscribers e proteger capacidade
...
Objetivo: Limitar SSE subscribers e proteger capacidade.

## Ordem de implementacao (arquivo a arquivo)
1. `backend/services/world/WorldEventStreamService.js`
2. `backend/config/index.js`
3. `backend/routes/ai-game.js`
4. `backend/tests/implementation-validation.test.js`
