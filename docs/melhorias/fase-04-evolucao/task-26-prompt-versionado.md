# Task 26 — Prompt versionado e configuravel
...
Objetivo: Prompt versionado e configuravel.

## Ordem de implementacao (arquivo a arquivo)
1. `backend/prompts/README.md`
2. `backend/prompts/npc-system-v1.md`
3. `backend/services/openai-client.js`
4. `backend/config/index.js`
