# Task 24 — Testes de integracao e E2E automatizados
...
Objetivo: Testes de integracao e E2E automatizados.

## Ordem de implementacao (arquivo a arquivo)
1. `backend/tests/integration/queue-worker.test.js`
2. `e2e/playwright/auth-hub-game.spec.ts`
